...
public class Magazine extends Publication {
    ...
    public Magazine(String title, String publisher, int releaseDate, int releaseMonth, int releaseDay, String language) {
        super(title, releaseDate, publisher);
        this.monthDay = MonthDay.of(releaseMonth, releaseDay);
